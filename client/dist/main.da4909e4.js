...
},{"./TaskItem":"../src/components/TaskItem.vue","../utils.js":"../src/utils.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../node_modules/parseuri/index.js":[function(require,module,exports) {
/**
 * Parses an URI
 *
...
},{"./common":"../node_modules/debug/src/common.js","process":"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../node_modules/socket.io-client/lib/url.js":[function(require,module,exports) {
...
},{"./url":"../node_modules/socket.io-client/lib/url.js","socket.io-parser":"../node_modules/socket.io-parser/index.js","./manager":"../node_modules/socket.io-client/lib/manager.js","debug":"../node_modules/debug/src/browser.js","./socket":"../node_modules/socket.io-client/lib/socket.js"}],"../src/App.vue":[function(require,module,exports) {
"use strict";
...
//
//
var socket = (0, _socket.default)(_utils.url);
var _default = {
  name: "App",
  components: {
  ...
  created: function created() {
    ...
    console.log('-----created----'); // this.getTaks();
    ...
    if (localStorage.getItem('access_token')) {
      ...
      socket.on('createTask', function (payload) {
        ...
        _this6.tasks.push(payload);
      });
      socket.on('deleteTask', function (id) {
        console.log('ini dari user sebelah', id);
        var temp = null;

        _this6.tasks.forEach(function (i, index) {
          if (i.id === id) {
            temp = index;
          }
        });

        _this6.tasks.splice(temp, 1);
      });
      socket.on('updateTask', function (payload) {
        console.log('ini dari user sebelah', payload);

        _this6.tasks.forEach(function (i) {
          if (i.id === payload.id) {
            i.title = payload.title;
            i.category = payload.category;
          }
...
exports.default = _default;
        var $4ecc09 = exports.default || module.exports;
      
      if (typeof $4ecc09 === 'function') {
        $4ecc09 = $4ecc09.options;
      }
    
        /* template */
        Object.assign($4ecc09, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$4ecc09', $4ecc09);
          } else {
            api.reload('$4ecc09', $4ecc09);
          }
        }
...
},{"./components/TaskList":"../src/components/TaskList.vue","./utils.js":"../src/utils.js","socket.io-client":"../node_modules/socket.io-client/lib/index.js","./../assets/logo.png":[["logo.c460f790.png","../assets/logo.png"],"../assets/logo.png"],"vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../node_modules/vue-google-oauth2/index.js":[function(require,module,exports) {
"use strict";
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "42421" + '/');
